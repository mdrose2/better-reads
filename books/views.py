...
class BookSearchView(TemplateView):
    ...
    Displays a search form and shows results from the API.
    Checks local database to indicate which books are already in the library.
    ...
    def get_context_data(self, **kwargs):
        """Add search results to context if query is provided."""
